...
class ResetPasswordController extends AbstractController
{
    ...
    /** Step 1 – show & process the "forgot password" form */
    ...
    /** Step 2 – confirmation page after the email is sent */
    ...
    /** Step 3 – validate the reset token & set a new password */
    ...
    private function processSendingPasswordResetEmail(string $emailFormData, MailerInterface $mailer): RedirectResponse
    {
        ...
        if (!$user) {
            // Respond the same way so we don't leak whether the email exists
