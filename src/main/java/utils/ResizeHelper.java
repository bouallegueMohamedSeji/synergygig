...
/**
 * Utility class to add resize functionality to an undecorated Stage.
 */
public class ResizeHelper {
    ...
    public static void addResizeListener(Stage stage) {
        ...
        // Also ensure children don't consume events that should trigger resize if on
        // border
    ...
    static class ResizeListener implements EventHandler<MouseEvent> {
        ...
        private int border = 12; // Pixel width of border zone
